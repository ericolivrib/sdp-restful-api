...
public record ProjetoAtualizadoResponseDto(UUID id, String numero, String nome, String modalidade, String justificativa, UUID usuarioId, Integer eixoTecnologicoId, String impactosAmbientais,
                                           LocalDate dataCricao, Short ano, StatusEnum status) {
    public ProjetoAtualizadoResponseDto(Projeto p) {
