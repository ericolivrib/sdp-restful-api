...
public record UpdateProjetoResponseDto(UUID id, String numero, String nome, String modalidade, String justificativa, UUID usuarioId, Integer eixoTecnologicoId, String impactosAmbientais,
                                       LocalDate dataCricao, Short ano, StatusEnum status) {
    public UpdateProjetoResponseDto(Projeto p) {
